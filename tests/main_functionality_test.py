...
from data.locators import  main_page_order_button, modal_loader, modal_ingredient, ingredient, create_order_modal, login_page_recover_password_button
...
class TestMainFunctional:
    ...
    def test_click_on_feed(self, driver, main_func):
        ...
        WebDriverWait(driver, 20).until(expected_conditions.invisibility_of_element_located(modal_loader))
    ...
    def test_click_on_ingredient(self, driver, main_func):
        ...
        WebDriverWait(driver, 20).until(expected_conditions.presence_of_element_located(modal_ingredient))
    ...
    def test_create_order(self, driver, main_func, test_user_create):
        ...
        main_func.input_email(test_user_create["email"])
        main_func.input_password(test_user_create["password"])
